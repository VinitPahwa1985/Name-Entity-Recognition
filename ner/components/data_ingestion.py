...
class DataIngestion:
    ...
    def extract_data(self, input_file_path: str, output_file_path: str) -> None:
        logging.info("Entered the extract_data method of Data ingestion class %s", input_file_path)
        try:
            # loading the temp.zip and creating a zip object
            input_file_path = os.path("C:\\DataSciecne\\Name-Entity-Recognition\\artifacts\\04_15_2024_11_28_09\\DataIngestionArtifacts\archive.zip")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifacts:
        ...
        try:
            ...
            logging.info("gcp_data_file_path %s", self.data_ingestion_config.gcp_data_file_path)
            logging.info("output_file_path %s", self.data_ingestion_config.output_file_path)
